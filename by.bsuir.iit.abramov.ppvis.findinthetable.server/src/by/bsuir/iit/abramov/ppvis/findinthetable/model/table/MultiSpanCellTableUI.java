...
public class MultiSpanCellTableUI extends BasicTableUI {
	...
	public void paint(final Graphics g, final JComponent c) {
		...
		final Rectangle rowRect = new Rectangle(0, 0, tableWidth, table.getRowHeight()
				+ table.getRowMargin());
	...
	private void paintCell(final Graphics g, final Rectangle cellRect, final int row,
			final int column) {
	...
	private void paintRow(final Graphics g, final int row) {
		...
		final AttributiveCellTableModel tableModel = (AttributiveCellTableModel) table
				.getModel();
